...
battery_temp = 25 + 5*sin(0.5*time); 
accX = 0.5*sin(2*time);  
accY = 0.3*cos(2*time); 
accZ = 9.81 + 0.1*sin(time); 
...
![WhatsApp Image 2025-08-19 at 11 45 41_ae558fe3](https://github.com/user-attachments/assets/e8832722-c956-4ffd-be50-eaaa8ec0ce6d)
